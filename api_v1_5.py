...
def list_files(request,*args,**kwargs):
	...
	:Method: Mountbit:Auth: 사용자 인증 토큰. 만약 공개 앨범이면, 매개 변수는 선택 사항.
...
def add_files(request,*args,**kwargs):
	...
	:Header: Mountbit:Auth: 사용자 인증 토큰. 만약 공개 앨범이면, 매개변수는 선택 사항.
...
def make_public(request,*args,**kwargs):
	...
	:Method: Mountbit:Auth: 사용자 인증 토큰.
...
def get_file_url(request,*args,**kwargs):
	...
	:Header: Method: Mountbit:Auth: 사용자 인증 토큰. 만약 공개 앨범이면, 매개변수는 선택 사항
